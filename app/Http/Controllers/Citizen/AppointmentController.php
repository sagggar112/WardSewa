...
class AppointmentController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('citizen.appointments.create', compact('citizen', 'serviceTypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('citizen.appointments.index')
            ->with('success', "Appointment {$aptNumber} booked successfully for {$appointment->appointment_date->format('Y-m-d')} ({$appointment->time_slot}).");
    }
}
