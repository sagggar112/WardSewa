...
@section('page_title', 'प्रणाली सुरक्षा तथा अडिट लग (System Audit Logs)')

@section('content')
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-black text-slate-900">सुरक्षा तथा कार्य सम्पादन अडिट लग</h1>
            <p class="text-xs text-slate-500 mt-0.5">प्रशासक लगइन, निवेदन स्थिति परिवर्तन, तथा महत्त्वपूर्ण प्रशासनिक गतिविधिको पूर्ण अभिलेख।</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
        <form method="GET" action="{{ route('staff.superadmin.audit-logs') }}" class="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
            <div class="sm:col-span-2">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="विवरणबाट खोज्नुहोस्..."
            ...
            <div>
                <select name="action" onchange="this.form.submit()" class="w-full px-3 py-2 border border-slate-300 rounded-lg text-xs">
                    <option value="">सबै गतिविधि (All Actions)</option>
            ...
            <table class="w-full text-left text-xs">
                <thead class="bg-slate-50 text-slate-600 border-b border-slate-200">
                    <tr>
                        ...
                        <th class="p-3">गतिविधि (Action)</th>
                        <th class="p-3">प्रशासक (Staff)</th>
                        <th class="p-3">विवरण (Description)</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse($logs as $log)
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="p-3 font-semibold text-slate-800">
                                {{ $log->staff ? $log->staff->name : 'प्रणाली (System)' }}
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="p-8 text-center text-slate-400 text-xs">कुनै अडिट गतिविधि फेला परेन।</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
